...
export default function Home() {
  return (
    <main>
      ...
      objectives. See Our Portfolio 01 02 03 04 Welcome Welcome to Arch Studio
      ...
      network put us in a strong position to deliver exceptional results. Over
      the past 10 years, we have worked on all kinds of projects. From stations
